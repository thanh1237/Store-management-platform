...
export const LOGIN_CUKCUK_REQUEST = "AUTH.LOGIN_CUKCUK_REQUEST";
export const LOGIN_CUKCUK_SUCCESS = "AUTH.LOGIN_CUKCUK_SUCCESS";
export const LOGIN_CUKCUK_FAILURE = "AUTH.LOGIN_CUKCUK_FAILURE";
